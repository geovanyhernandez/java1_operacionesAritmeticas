...
public class Main {
	...
	public static void main (String args[]) {
		...
		int numero1, numero2, resultadoSuma, resultadoResta, resultadoMult, resultadoDiv;
		...
		resultadoMult = operaciones.mult(numero1, numero2);
		...
		System.out.println("\nEl resultado de la RESTA es: " + resultadoResta);
	        System.out.println("\nEl resultado de la MULTIPLICACION es: " + resultadoMult);
